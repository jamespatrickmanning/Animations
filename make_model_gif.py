...
Min_temp,Max_temp=cm.temp_min_max(model_name,dt=start_date_datetime,interval=ndays,area=area)
#make images
cm.make_images(model_name,dpath=dictionary,path=map_save,dt=start_date_datetime,interval=ndays,Min_temp=Min_temp,Max_temp=Max_temp,area=area)
